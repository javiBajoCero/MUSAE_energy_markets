...
SETS
g  Generation units / G1*G6/
bg Blocks           /b1*b2/;

PARAMETERS
pg_max(g) Max. active power generation [MW] /G1 300, G2 275, G3 100, G4 50, G5 200, G6 99999/
pg_min(g) Min. active power generation [MW] /G1 30,  G2 28,  G3 10, G4 5, G5 20, G6 0/
ru(g)     Ramp-up limit [MW:h]              /G1 100, G2 30,  G3 25, G4 10, G5 50, G6 99999/
rd(g)     Ramp-down limit [MW]              /G1 100, G2 30,  G3 20, G4 10, G5 50, G6 99999/
